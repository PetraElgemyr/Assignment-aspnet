...
public class AzureFileHandler(string connectionString, string containerName) : IAzureImageHandler
{


    private readonly BlobContainerClient _containerClient = new BlobContainerClient(connectionString, containerName);
